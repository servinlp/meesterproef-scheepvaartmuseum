function uploadFormTest() {
	...
	const dataAdd = Array.from( document.querySelector( '[data-add]' ) )
...
function addTextarea() {
	...
	textarea.setAttribute( 'name', `storyText-${ allTextareas.length }` )
...
function addFileInput() {
	...
	input.setAttribute( 'name', `upload-${ allFileInputs.length }` )
...
function addInput( type ) {
	...
	input.setAttribute( 'data-index', allInputElements.length )
	input.setAttribute( 'name', `${ type }-${ allFileInputs.length }` )
